document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    console.log("hasEnded", quiz.hasEnded());
    if (quiz.hasEnded()) {
      showResults();
      return;
    }
    ...
    // question.forEach(() => {
    //   questionContainer.innerHTML = question.shuffleChoices();
    // });
  ...
  // document.endView.restartButton.onclick((click) => {
  //   if (click === true) {
